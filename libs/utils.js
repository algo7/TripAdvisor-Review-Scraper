...
/**
 * Reshape the object in the review array 
 * @param {Array<Object>} arrayToBeProcessed 
 * @returns {Array<Object>}
 */
const dataProcessor = (arrayToBeProcessed) => {
    try {
        const processed = arrayToBeProcessed.map(data => {
            const { fileName, } = data;
